...
import hr.ja.config.audit.AuditEventConverter;
import hr.ja.domain.PersistentAuditEvent;
...
import static hr.ja.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
