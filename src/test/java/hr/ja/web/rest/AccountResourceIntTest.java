package hr.ja.web.rest;

import hr.ja.config.Constants;
import hr.ja.CajgerHipsterApp;
import hr.ja.domain.Authority;
import hr.ja.domain.User;
import hr.ja.repository.AuthorityRepository;
import hr.ja.repository.UserRepository;
import hr.ja.security.AuthoritiesConstants;
import hr.ja.service.MailService;
import hr.ja.service.dto.UserDTO;
import hr.ja.web.rest.errors.ExceptionTranslator;
import hr.ja.web.rest.vm.KeyAndPasswordVM;
import hr.ja.web.rest.vm.ManagedUserVM;
import hr.ja.service.UserService;
...
@SpringBootTest(classes = CajgerHipsterApp.class)
